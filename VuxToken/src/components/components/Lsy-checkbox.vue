<template>
    ...
    <group  label-width="5.5em" label-margin-right="0em"  label-align="left"  style=" margin-top: -20px;;" >
        ...
        <div v-transfer-dom>
            ...
            <checker v-model="Maindata1" type="checkbox" default-item-class="default-item" selected-item-class="item-selected" disabled-item-class="item-disabled" >
...
export default {
 ...
 name: 'Lsy-checkbox', // 注意这里的name命名，就是你以后封装好后使用的组件名
