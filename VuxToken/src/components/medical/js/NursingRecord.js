        ...
        methods:{
            ...
            NumRule1(val){
                ...
                console.log(val.replace(/[^\d]/g,''))
                    if(val.replace(/[^\d]/g,'')==''){
                        this.GoodModel.form.Num=0
                    }else{
                        this.GoodModel.form.Num=val.replace(/[^\d]/g,'')
                    }
            ...
            console.log(val.replace(/[^\d]/g,''))
                if(val.replace(/[^\d]/g,'')==''){
                    this.GoodModel.form.LossVal=0
                }else{
                    this.GoodModel.form.LossVal=val.replace(/[^\d]/g,'')
                }
       ...
       // this.DataModel.form.JZResults=this.$route.params.Record.JZResults!=null?this.$route.params.Record.JZResults.split(','):this.$route.params.Record.JZResults=''.split(',')
        ...
        DeleteHC(row){
            ...
            this.baseAjax({
                ...
                showLoading:true,
                type:'post',
                params:{PatientRecordID:this.$store.state.TaskCode+this.$store.state.PatientOrder,
                    ID:row.ID,
