<template>
        ...
        <div  v-if="!ShowTentativeDiagnose">
          <x-header class="vux-header-box"  style="background:linear-gradient(to right, #447bba  , #7a88bd,  #928dba);color:black;" >
              ...
              救治措施<!--<a slot="right" style="color:black "   @click="SaveTGinfo()">保存</a>  -->
              <a slot="right"  style="color:black "   @click="Back()">保存</a>
              </x-header>
          </div>
          <div v-if="ShowTentativeDiagnose">
        ...
        <!-- <x-header class="vux-header-box"  style="background:linear-gradient(to right, #447bba  , #7a88bd,  #928dba);color:black;" >
          救治措施<a slot="right" style="color:black "   @click="Back()">完成</a></x-header> -->
            ...
            <div v-show="!ShowTentativeDiagnose">
              <popup-picker title="打包医嘱" :data="[DoctorOrderList]" show-name v-model="DoctorOrder" value-text-align="left"></popup-picker>
          ...
          <!-- 
            ...
            <el-table-column  header-align="center"  align="center"  width="50" label="编辑">
              <template slot-scope="scope">
                  <img slot="icon" src="../../assets/images/icons/Edit-small.png"  @click="handleEdit(scope.$index, scope.row)">
                
              </template>
            </el-table-column>
            <el-table-column    header-align="center"  align="center" width="50" label="删除">
              <template slot-scope="scope">
            ...
            <el-table-column   header-align="center" align="center"   width="50" label="调整">
              <template slot-scope="scope">
                  <img slot="icon" src="../../assets/images/icons/Up-small.png"  @click="TreamentUp(scope.row)">
                
                  <!-- <img slot="icon" src="../../assets/images/icons/Down-small.png"  @click="TreamentDown( scope.row)"> -->
